...
//           className="request-form container bg-light p-4 shadow-sm rounded"
//         >
...
function RequestRepair() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire("Error", err.response?.data || "Failed to submit repair request.", "error");
    }
  };
          ...
          <div className="row g-3">
            ...
            <div className="col-md-6">
              ...
              <input
                ...
                className="form-control"
                value={formData.preferredPickupAt}
                onChange={handleChange}
              />
            </div>
